...
def main():
    ...
    setup(
        ...
        description=("Python utilities used for handling and raising exceptions"),
        include_package_data=True,
        install_requires=install_requirements,
        keywords=["python", "libraries", "exceptions"],
        license="MIT",
        long_description=readme,
        long_description_content_type='text/markdown',
        name="ctodd-python-lib-exceptions",
        packages=packages,
        project_urls={},
        python_requires=">3.6",
        setup_requires=setup_requirements,
        tests_require=test_requirements,
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-exceptions",
        version=version,
    )
